...
{
    /// <inheritdoc />
    public partial class intitlcreateg : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubervisorId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Instructors_Departments_DepartmentDID",
                        column: x => x.DepartmentDID,
                        principalTable: "Departments",
                        principalColumn: "DID");
                    table.ForeignKey(
                        name: "FK_Instructors_Instructors_SubervisorId",
                        column: x => x.SubervisorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Instructors_DepartmentDID",
                table: "Instructors",
                column: "DepartmentDID");

            migrationBuilder.CreateIndex(
                name: "IX_Instructors_SubervisorId",
                table: "Instructors",
                column: "SubervisorId");
